...
TH2F *front_back_energy, *tig_s3_time, *s3_E_theta, *laser_amp_addback_E, *laser_wf_overlay, *laser_amp_ts, *s3_ring_charge;

TH2F *tigE_angle_beamcut, *ran_tigE_angle_beamcut;
TH2F *tigE_angle_targetcut, *ran_tigE_angle_targetcut;
TH2F *tigdopp_angle_beamcut;
TH2F *tigdopp_angle_targetcut;
TH2F *tigE_dCfd;
...
TH2F *tigE_angle_upstream, *ran_tigE_angle_upstream;
TH2F *tig_beam_beam_DOWN_Ring, *ran_tig_beam_beam_DOWN_Ring;
TH2F *tig_beam_beam_UP_Ring, *ran_tig_beam_beam_UP_Ring;

TH1F *tig_dopp_beam_beamcut, *ran_tig_dopp_beam_beamcut;
TH1F *tig_dopp_target_beamcut, *ran_tig_dopp_target_beamcut;
TH1F *tig_dopp_beam_upstream, *ran_tig_dopp_beam_upstream; 
TH1F *tig_dopp_target_upstream, *ran_tig_dopp_target_upstream; 
TH1F *tig_dopp_beam_targetcut, *ran_tig_dopp_beam_targetcut;
TH1F *tig_dopp_target_targetcut, *ran_tig_dopp_target_targetcut;
...
TH2F *E_Theta_Gamma_Gate, *ran_E_Theta_Gamma_Gate;
