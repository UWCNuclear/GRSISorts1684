...
void Sortcode::Initialise(){
	...
	tigE_angle_upstream = new TH2F("TIGRESS_E_vs_angle_Upstream","TIGRESS_E_vs_angle_Upstream",2048,0,2048,180,0,180); gatedlist->Add(tigE_angle_upstream); // Nikita
	...
	tig_dopp_beam_upstream = new TH1F("Upstream_Beam_Doppler_Corrected","Upstream_Beam_Doppler_Corrected",2048,0,4096); gatedlist->Add(tig_dopp_beam_upstream);
	tig_dopp_target_upstream = new TH1F("Upstream_Target_Doppler_Corrected","Upstream_Target_Doppler_Corrected",2048,0,4096); gatedlist->Add(tig_dopp_target_upstream);

	ran_tig_dopp_beam_beamcut = new TH1F("ran_TIGRESS_E_Beam_Cut_Beam_Doppler","ran_TIGRESS_E_Beam_Cut_Beam_Doppler",2048,0,4096); gatedlist->Add(ran_tig_dopp_beam_beamcut); // Nikita
	ran_tig_dopp_target_beamcut = new TH1F("ran_TIGRESS_E_Beam_Cut_Target_Doppler","ran_TIGRESS_E_Beam_Cut_Target_Doppler",2048,0,4096); gatedlist->Add(ran_tig_dopp_target_beamcut); // Nikita
	ran_tigE_angle_beamcut = new TH2F("ran_TIGRESS_E_vs_angle_BeamCut","ran_TIGRESS_E_vs_angle_BeamCut",2048,0,2048,180,0,180); gatedlist->Add(ran_tigE_angle_beamcut); // Nikita 
	ran_tig_dopp_beam_targetcut = new TH1F("ran_TIGRESS_E_Target_Cut_Beam_Doppler","ran_TIGRESS_E_Target_Cut_Beam_Doppler",2048,0,4096); gatedlist->Add(ran_tig_dopp_beam_targetcut); // Nikita
	ran_tig_dopp_target_targetcut = new TH1F("ran_TIGRESS_E_Target_Cut_Target_Doppler","ran_TIGRESS_E_Target_Cut_Target_Doppler",2048,0,4096); gatedlist->Add(ran_tig_dopp_target_targetcut); // Nikita
	ran_tigE_angle_targetcut = new TH2F("ran_TIGRESS_E_vs_angle_TargetCut","ran_TIGRESS_E_vs_angle_TargetCut",2048,0,2048,180,0,180); gatedlist->Add(ran_tigE_angle_targetcut);// Nikita
	ran_tig_dopp_beam_upstream = new TH1F("ran_Upstream_Beam_Doppler_Corrected","ran_Upstream_Beam_Doppler_Corrected",2048,0,4096); gatedlist->Add(ran_tig_dopp_beam_upstream); // Nikita
	ran_tig_dopp_target_upstream = new TH1F("ran_Upstream_Target_Doppler_Corrected","ran_Upstream_Target_Doppler_Corrected",2048,0,4096); gatedlist->Add(ran_tig_dopp_target_upstream); // Nikita
	ran_tigE_angle_upstream = new TH2F("ran_TIGRESS_E_vs_angle_Upstream","ran_TIGRESS_E_vs_angle_Upstream",2048,0,2048,180,0,180); gatedlist->Add(ran_tigE_angle_upstream); // Nikita
	...
	ran_E_Theta_Gamma_Gate = new TH2F("ran_E_Theta_Gamma_Gate","ran_E_Theta_Gamma_Gate",180,0,180,2048,0,65536); timelist->Add(ran_E_Theta_Gamma_Gate);
	...
	tig_beam_beam_DOWN_Ring = new TH2F("TIGRESS_Beam_Gated_Beam_Doppler_DOWN_Ring","TIGRESS_Beam_Gated_Beam_Doppler_DOWN_Ring",2048,0,2048,24,0,24); combolist->Add(tig_beam_beam_DOWN_Ring); // Nikita

	ran_tig_beam_beam_DOWN_Ring = new TH2F("ran_TIGRESS_Beam_Gated_Beam_Doppler_DOWN_Ring","ran_TIGRESS_Beam_Gated_Beam_Doppler_DOWN_Ring",2048,0,2048,24,0,24); combolist->Add(ran_tig_beam_beam_DOWN_Ring); // Nikita

	tig_beam_beam_UP_Ring = new TH2F("TIGRESS_Beam_Gated_Beam_Doppler_UP_Ring","TIGRESS_Beam_Gated_Beam_Doppler_UP_Ring",2048,0,2048,24,0,24); combolist->Add(tig_beam_beam_UP_Ring); // Nikita

	ran_tig_beam_beam_UP_Ring = new TH2F("ran_TIGRESS_Beam_Gated_Beam_Doppler_UP_Ring","ran_TIGRESS_Beam_Gated_Beam_Doppler_UP_Ring",2048,0,2048,24,0,24); combolist->Add(ran_tig_beam_beam_UP_Ring); // Nikita

/*	for(int i=0;i<24;i++){
		char hname[64];
		sprintf(hname,"TIGRESS_Beam_Gated_Beam_Doppler_DOWN_Ring%i",i+1);
		tig_beam_beam_DOWN_Ring[i] = new TH1F(hname,hname,2048,0,2048); combolist->Add(tig_beam_beam_DOWN_Ring[i]);
	} // Nikita

	for(int i=0;i<24;i++){
		char hname[64];
		sprintf(hname,"TIGRESS_Beam_Gated_Beam_Doppler_UP_Ring%i",i+1);
		tig_beam_beam_UP_Ring[i] = new TH1F(hname,hname,2048,0,2048); combolist->Add(tig_beam_beam_UP_Ring[i]);
	} // Nikita
*/
	for(int i=0;i<4;i++){
		char hname[64];
	...
	for(int i=0;i<21;i++){
		for(int j=0;j<21;j++){
			...
			float x = i*0.5 - 5;
			float y = j*0.5 - 5;		
			sprintf(hname,"Hitmap_iter_%.1f_%.1f",x,y);
