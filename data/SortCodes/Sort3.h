...
void Sortcode::Initialise(){
	...
	ran_tig_dopp_beam_upstream = new TH1F("ran_Upstream_Beam_Doppler_Corrected","ran_Upstream_Beam_Doppler_Corrected",8192,0,8192); gatedlist->Add(ran_tig_dopp_beam_upstream); // Nikita
	ran_tig_dopp_target_upstream = new TH1F("ran_Upstream_Target_Doppler_Corrected","ran_Upstream_Target_Doppler_Corrected",8192,0,8192); gatedlist->Add(ran_tig_dopp_target_upstream); // Nikita
